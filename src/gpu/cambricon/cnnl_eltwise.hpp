...
#ifndef GPU_CAMBRICON_SYCL_BANG_ELTWISE_HPP
#define GPU_CAMBRICON_SYCL_BANG_ELTWISE_HPP
...
struct cnnl_eltwise_fwd_t : public primitive_t {
    ...
    struct pd_t : public eltwise_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("bang:cnnl:any", cnnl_eltwise_fwd_t);
        ...
        std::shared_ptr<cnnl_eltwise_fwd_impl_t> eltwise_fwd_impl_;
    };
...
struct cnnl_eltwise_bwd_t : public primitive_t {
    ...
    struct pd_t : public eltwise_bwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("bang:cnnl:any", cnnl_eltwise_bwd_t);
        ...
        std::shared_ptr<cnnl_eltwise_bwd_impl_t> eltwise_bwd_impl_;
    };
