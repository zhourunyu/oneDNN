...
public:
    ...
    CNqueue get_underlying_stream();
    CNcontext get_underlying_context();
    CNdev get_underlying_device();

private:
    status_t init();
    sycl_bang_stream_t(engine_t *engine, unsigned flags, ::sycl::queue &queue)
