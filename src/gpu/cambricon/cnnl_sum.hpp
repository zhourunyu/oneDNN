...
#ifndef GPU_CAMBRICON_CNNL_SUM_HPP
#define GPU_CAMBRICON_CNNL_SUM_HPP
...
struct cnnl_ref_sum_t : public ::dnnl::impl::gpu::ocl::ref_sum_t {
    ...
    struct pd_t : public base_pd_t {
        ...
        DECLARE_SUM_PD_T("ref:any", cnnl_ref_sum_t);
